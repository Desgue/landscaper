...
// the parsed request and resolved EffectiveOptions. If validation fails, it
// writes the error response and returns false.
func validateAndParse(w http.ResponseWriter, r *http.Request) (model.GenerateRequest, model.EffectiveOptions, bool) {
...
func validateAndParseWithTime(w http.ResponseWriter, r *http.Request, now time.Time) (model.GenerateRequest, model.EffectiveOptions, bool) {
	// 1. Body size limit
	...
	if err != nil {
		...
		return model.GenerateRequest{}, model.EffectiveOptions{}, false
	}
